 ...
 */
export interface RequestOptions extends Omit<FetchOptions, 'method' | 'body' | 'responseType'> {
...
function getLocaleFromCookies(): string {
  if (typeof window !== 'undefined') {
    ...
    try {
      if (typeof globalThis !== 'undefined' && (globalThis as any).__NEXT_LOCALE__) {
...
export const jsonToFormData = (
  ...
  if (typeof json === 'object' && !(json instanceof File) && !(json instanceof Blob)) {
  ...
  const client = ofetch.create({
    ...
    onRequest({ options }: FetchContext) {
      ...
      if (useFormData && options.body && typeof options.body === 'object') {
        ...
        // For external APIs that expect JSON, ensure Content-Type is set
